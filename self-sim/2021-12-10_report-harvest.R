...
#          .after = uSeed)
# harv_podar <- readRDS("fit-harvest_N-100_T-100_PoDAR_resid-fixed.random.rds")
#
...
summary_resid.fixed <- report_harvest(harv = harv %>% filter(type == "resid.fixed"),
                                      my.standardization = "stdyx",
                                      my.param.name = "X.WITH.PHI",
                                      what = "summary") %>%
  mutate(type = "resid.fixed",
...
summary_resid.random <- report_harvest(harv = harv %>% filter(type == "resid.random"),
                                       my.standardization = "stdyx",
                                       my.param.name = "X.WITH.PHI",
                                       what = "summary") %>%
  mutate(type = "resid.random",
